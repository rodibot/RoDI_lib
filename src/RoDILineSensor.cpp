...
RoDILineSensor::RoDILineSensor(int pin)
{
  _pin = pin;
  _BGLevel = -1;
  _detectLevel = -1;
...
//  set, returns true.
boolean RoDILineSensor::calStatus()
{
...
//  variables. 
int RoDILineSensor::setDetectLevel()
{
